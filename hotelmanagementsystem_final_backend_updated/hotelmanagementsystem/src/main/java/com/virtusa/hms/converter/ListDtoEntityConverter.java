...
public class ListDtoEntityConverter {
    ...
    public RoomDto convertRoomEntityToDto(Room room) {
        ...
        roomDto.setHotelDto(convertHotelEntityToDto(room.getHotel()));
        return roomDto;
    }
    ...
    public AttractionDto convertAttractionEntityToDto(Attraction attraction) {
        ...
        attractionDto.setAttractionPhone(attraction.getAttractionPhone());
        attractionDto.setAttractionDescription(attraction.getAttractionDescription());
        attractionDto.setAttractionImage(attraction.getAttractionImage());
        attractionDto.setAttractionRating(attraction.getAttractionRating());
    ...
    public Attraction convertAttractionDtoToEntity(AttractionDto attractionDto) {
        ...
        attraction.setAttractionPhone(attractionDto.getAttractionPhone());
        attraction.setAttractionDescription(attractionDto.getAttractionDescription());
        attraction.setAttractionImage(attractionDto.getAttractionImage());
        attraction.setAttractionRating(attractionDto.getAttractionRating());
    ...
    public List<Attraction> convertAttractionDtoListToEntityList(List<AttractionDto> attractionDtos) {
        return attractionDtos.stream().map(this::convertAttractionDtoToEntity).collect(Collectors.toList());
    }

    public List<DiningRecommendation> convertDiningRecommendationDtoListToEntityList(List<DiningRecommendationDto> diningRecommendationDtos) {
        return diningRecommendationDtos.stream().map(this::convertDiningRecommendationDtoToEntity).collect(Collectors.toList());
    }
    ...
    public List<ReviewDto> convertReviewEntityListToDto(List<Review> review) {
        return review.stream().map(this::convertReviewEntityToDto).collect(Collectors.toList());
    }

    public List<Review> convertReviewDtoListToEntity(List<ReviewDto> reviewDto) {
        if (reviewDto == null)
            return Collections.emptyList();
        return reviewDto.stream().map(this::convertReviewDtoToEntity).collect(Collectors.toList());
    }
    ...
    public DiningRecommendationDto convertDiningRecommendationEntityToDto(DiningRecommendation diningRecommendation) {
        ...
        diningRecommendationDto.setCuisineType(diningRecommendation.getCuisineType());
        diningRecommendationDto.setPriceRange(diningRecommendation.getPriceRange());
        diningRecommendationDto.setOperatingHours(diningRecommendation.getOperatingHours());
        diningRecommendationDto.setContactNumber(diningRecommendation.getContactNumber());
        diningRecommendationDto.setWebsiteUrl(diningRecommendation.getWebsiteUrl());
        diningRecommendationDto.setCapacity(diningRecommendation.getCapacity());
        diningRecommendationDto.setIsOutdoorSeatingAvailable(diningRecommendation.getIsOutdoorSeatingAvailable());
        diningRecommendationDto.setIsParkingAvailable(diningRecommendation.getIsParkingAvailable());
        diningRecommendationDto.setIsWifiAvailable(diningRecommendation.getIsWifiAvailable());
        diningRecommendationDto.setIsReservationRequired(diningRecommendation.getIsReservationRequired());
        diningRecommendationDto.setSpecialFeatures(diningRecommendation.getSpecialFeatures());
    ...
    public DiningRecommendation convertDiningRecommendationDtoToEntity(DiningRecommendationDto diningRecommendationDto) {
        ...
        diningRecommendation.setCuisineType(diningRecommendationDto.getCuisineType());
        diningRecommendation.setPriceRange(diningRecommendationDto.getPriceRange());
        diningRecommendation.setOperatingHours(diningRecommendationDto.getOperatingHours());
        diningRecommendation.setContactNumber(diningRecommendationDto.getContactNumber());
        diningRecommendation.setWebsiteUrl(diningRecommendationDto.getWebsiteUrl());
        diningRecommendation.setCapacity(diningRecommendationDto.getCapacity());
        diningRecommendation.setIsOutdoorSeatingAvailable(diningRecommendationDto.getIsOutdoorSeatingAvailable());
        diningRecommendation.setIsParkingAvailable(diningRecommendationDto.getIsParkingAvailable());
        diningRecommendation.setIsWifiAvailable(diningRecommendationDto.getIsWifiAvailable());
        diningRecommendation.setIsReservationRequired(diningRecommendationDto.getIsReservationRequired());
        diningRecommendation.setSpecialFeatures(diningRecommendationDto.getSpecialFeatures());
        return diningRecommendation;
    }

    public List<DiningRecommendationDto> convertDiningRecommendationEntityListToDtoList(List<DiningRecommendation> diningRecommendations) {
        return diningRecommendations.stream().map(this::convertDiningRecommendationEntityToDto).collect(Collectors.toList());
    }

    public List<AttractionDto> convertAttractionEntityListToDtoList(List<Attraction> attractions) {
        return attractions.stream().map(this::convertAttractionEntityToDto).collect(Collectors.toList());
    }

    public List<HotelDto> convertHotelEntityListToDtoList(List<Hotel> hotels) {
        return hotels.stream().map(this::convertHotelEntityToDto).collect(Collectors.toList());
    }

    public List<RoomDto> convertRoomEntityListToDtoList(List<Room> rooms) {
        return rooms.stream().map(this::convertRoomEntityToDto).collect(Collectors.toList());
    }

    public List<Room> convertRoomDtoListToEntityList(List<RoomDto> roomDto) {
        return roomDto.stream().map(this::convertRoomDtoToEntity).collect(Collectors.toList());
    }
    ...
    public List<BookingDto> convertBookingEntityListToDtoList(List<Booking> bookings) {
        return bookings.stream().map(this::convertBookingEntityToDto).collect(Collectors.toList());
    }
}